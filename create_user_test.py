...
def negative_assert(first_name):
    #сохранили обновленное тело запроса в переменную user_body
    user_body = get_user_body(first_name)
    ...
    #  в теле ответа тож есть  атрибут "code" и он равен 400
...
# Тест 6
# firstname = "Мария" (cyrillic only)
def test_create_user_cyrillic_letter_in_first_name_get_success_response():
    positive_assert("Мария")



# Тест 7
# firstname = "Человек и КО" (пробелы не допустимы)
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert("Человек и КО")
#на 7 тесте вроде бы фейл



# Тест 8
# firstname = "№%@" (спецсимволы не допустимы)
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert("№%@")


# Тест 9
# firstname = "123" (цифры строкой не допустимы)
